...
class ViawarnUsAzDotStream(HttpStream, ABC):

    url_base = "https://az511.com/api/v2/get/"
...
class Event(ViawarnUsAzDotStream):
...
class Sign(ViawarnUsAzDotStream):
...
# Source
class SourceViawarnUsAzDot(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        return [Event(config=config), Sign(config=config)]
