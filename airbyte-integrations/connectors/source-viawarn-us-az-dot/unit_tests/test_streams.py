...
import pytest
from source_viawarn_us_az_dot.source import ViawarnUsAzDotStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ViawarnUsAzDotStream, "path", "v0/example_endpoint")
    mocker.patch.object(ViawarnUsAzDotStream, "primary_key", "test_primary_key")
    mocker.patch.object(ViawarnUsAzDotStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ViawarnUsAzDotStream()
