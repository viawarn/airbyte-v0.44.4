...
import pytest
from source_viawarn_us_ak_dot.source import ViawarnUsAkDotStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ViawarnUsAkDotStream, "path", "v0/example_endpoint")
    mocker.patch.object(ViawarnUsAkDotStream, "primary_key", "test_primary_key")
    mocker.patch.object(ViawarnUsAkDotStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ViawarnUsAkDotStream()
